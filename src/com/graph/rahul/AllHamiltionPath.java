...
public class AllHamiltionPath
{
	public static void printAllHamiltionPath(Graph g, int v,
						boolean[] visited, List<Integer> path, int N)
	{
		...
		for (int w : g.adjList.get(v))
		{
			...
			if (!visited[w])
			{
				...
				// to solution or not
				printAllHamiltionPath(g, w, visited, path, N);
	...
	public static void main(String[] args)
	{
		...
		printAllHamiltionPath(g, start, visited, path, N);
	}
}